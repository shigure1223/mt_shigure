...
% 機能と構造について説明
TRPV3はxxxx個のアミノ酸残基で構成されており、膜タンパク質であり、ホモ4量体を形成する。(図\ref{fig:trpv3})% TODO: ここに構造の画像を入れる
200xヒトゲノムをTRPV1で検索した際に発見された。% TODO: いつ？
...
また、原子数が大きいためクライオ電子顕微鏡が登場するまでは一部のドメインのみの構造解析  に, とどまっていたが、
