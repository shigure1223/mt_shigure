...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{interedge_modularities.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{interedge_modularities_diff.png}
  \caption{$\beta_2$ARの各コミュニティのコミュニティ間エッジ密度の変化を示した図。コミュニティの名称は、図\ref{fig:inactive}と図\ref{fig:active}で名付けたものである。}
